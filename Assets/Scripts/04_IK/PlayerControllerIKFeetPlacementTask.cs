...
public class PlayerControllerIKFeetPlacementTask : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //anim.AddComponent<PlayerControllerIKFeetPlacementTask>(this);
    }
    ...
    private void OnAnimatorIK(int layerIndex)
    {
        ...
        anim.SetIKHintPositionWeight(AvatarIKHint.LeftKnee,1.0f);
        anim.SetIKHintPositionWeight(AvatarIKHint.RightKnee,1.0f);
    ...
    void MoveFeetToIKPoint(AvatarIKGoal foot, Vector3 positionIKHolder, Quaternion rotationIKHolder, ref float lastFootPositionY)
    {
        ...
        if (positionIKHolder != Vector3.zero)
        {
            ...
            */
            ...
            /*float angle = Quaternion.Angle(anim.GetIKRotation(foot),rotationIKHolder);
            if(angle >= 120f){
